...
export default function FeatureCard({ icon: Icon, title, description }: FeatureCardProps) {
  return (
    <Card className="p-6 glass hover-elevate active-elevate-2 transition-all duration-300 group border border-white/10">
      <div className="mb-4 inline-block p-3 rounded-lg bg-primary/10 glow-cyan group-hover:scale-110 transition-transform">
